...
def get_jobs(keyword, num_jobs, verbose,path,slp_time):
    ...
    url = 'https://www.glassdoor.com/Job/jobs.htm?sc.keyword=' + keyword + '&suggestCount=0&suggestChosen=false&clickSource=searchBox&locId=170&locT=N&locName=Malaysia'
    ...
    while len(jobs) < num_jobs:  #If true, should be still looking for new jobs.
        ...
        if not (len(jobs) >= num_jobs):
            ...
            for job_button in job_buttons:  
                ...
                try:
                    salary_estimate = driver.find_element_by_xpath('//*[@id="MainCol"]//li['+ str(currentJoblist + 1) +']//span[@data-test="detailSalary"]').text
